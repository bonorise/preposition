...
- [ ] SEO｜详情页内容优化清单（初学者+SEO评分>=85 视为完成；2026-02-14；完成 34/51）
- [x] in (/in) score=95
- [x] on (/on) score=95
...
- [ ] in back of (/in-back-of) score=80
- [x] ahead of (/ahead-of) score=90
- [x] close to (/close-to) score=95
- [ ] far from (/far-from) score=80
